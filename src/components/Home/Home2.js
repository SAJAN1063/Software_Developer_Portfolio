        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            I fell in love with programming and have learned quite a bit, I think...  🤷‍♂️
              ...
              <i>
                <b className="purple"> C++, HTML, CSS, and SDLC. </b>
              </i>
              <br />
              <br />
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/SAJAN1063"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://x.com/sajangu63601846"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/sajan-gupta-921113220/"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
              ...
              <li className="social-icons">
                <a
                  href="https://www.instagram.com/thesajannn"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour home-social-icons"
                >
